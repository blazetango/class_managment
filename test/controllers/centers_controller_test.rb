...
class CentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create center" do
    assert_difference('Center.count') do
      post centers_url, params: { center: { address: @center.address, budget: @center.budget, name: @center.name } }
    end
  ...
  test "should update center" do
    patch center_url(@center), params: { center: { address: @center.address, budget: @center.budget, name: @center.name } }
