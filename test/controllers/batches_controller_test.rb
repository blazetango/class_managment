...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { day: @batch.day, duration: @batch.duration, name: @batch.name, timing: @batch.timing } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { day: @batch.day, duration: @batch.duration, name: @batch.name, timing: @batch.timing } }
